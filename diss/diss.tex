...
\begin{comment}
- reference exactly/upto illustrations from text
...
- Software engineering - I think it would be good to briefly describe the way you worked - waterfall model or whatever you used - perhaps under the previous software engineering section.  You could also add in a requirements analysis for the different features you wanted to or had to include.

- (implementation) - This chapter could do with a short summary to highlight key implementation points and link to the evaluation.

- (Evaluation) - Reference result graphs
- Describe test-table queries
