...
package object schema {
  ...
  sealed trait Findable[A] extends FindSingleAble[A] {
    implicit def sa: SchemaObject[A]
    /**
  ...
  sealed trait DBTuple[A] extends Findable[A] {
    val schema: SchemaObject[A]
    override implicit def sa: SchemaObject[A] = schema
  ...
  /**
    ...
    */
  case class DBTuple0[Res](n: TableName, schema: SchemaObject[Res]) extends DBTuple[Res] {
  ...
  case class DBTuple1[Res, A1](n: TableName, schema: SchemaObject[Res], a1: A1)(implicit s1: Storeable[A1]) extends DBTuple[Res]{
  ...
  case class DBTuple2[Res, A1, A2](n: TableName, schema: SchemaObject[Res], a1: A1, a2: A2)(implicit s1: Storeable[A1], s2: Storeable[A2]) extends DBTuple[Res]{
  ...
  case class DBTuple3[Res, A1, A2, A3](n: TableName, schema: SchemaObject[Res], a1: A1, a2: A2, a3: A3)(implicit s1: Storeable[A1], s2: Storeable[A2], s3: Storeable[A3]) extends DBTuple[Res]{
  ...
  case class DBTuple4[Res, A1, A2, A3, A4](n: TableName, schema: SchemaObject[Res], a1: A1, a2: A2, a3: A3, a4: A4)(implicit s1: Storeable[A1], s2: Storeable[A2], s3: Storeable[A3], s4: Storeable[A4]) extends DBTuple[Res]{
  ...
  case class Pattern0[Res](n: TableName, schema: SchemaObject[Res]) extends Pattern[Res] {
    override def toSchemaComponent: Vector[SchemaComponent] = Vector()
    override def tableName: TableName = n
    override def pattern: Vector[Option[DBCell]] = Vector()
  }

  case class Pattern1[Res, A1](n: TableName, schema: SchemaObject[Res], a1: Option[A1])(implicit s1: Storeable[A1]) extends Pattern[Res] {
  ...
  case class Pattern2[Res, A1, A2](n: TableName, schema: SchemaObject[Res], a1: Option[A1], a2: Option[A2])(implicit s1: Storeable[A1], s2: Storeable[A2]) extends Pattern[Res] {
  ...
  case class Pattern3[Res, A1, A2, A3](n: TableName, schema: SchemaObject[Res], a1: Option[A1], a2: Option[A2], a3: Option[A3])(implicit s1: Storeable[A1], s2: Storeable[A2], s3: Storeable[A3]) extends Pattern[Res] {
  ...
  case class Pattern4[Res, A1, A2, A3, A4](n: TableName, schema: SchemaObject[Res], a1: Option[A1], a2: Option[A2], a3: Option[A3], a4: Option[A4])(implicit s1: Storeable[A1], s2: Storeable[A2], s3: Storeable[A3], s4: Storeable[A4]) extends Pattern[Res] {
