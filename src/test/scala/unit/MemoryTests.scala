...
class MemoryTests extends HasBackend with Duplicates with IntersectionsAndDisjunctions with ReadWrite with Transitive with Repetition with ComplexRepetition {
